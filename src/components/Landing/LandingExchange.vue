<template>
  <div class="flex items-center space-x-4">
    ...
    >
      <span class="text-sm font-medium pr-5 py-3 text-[#0c66ee] border-r border-[#0c66ee]">{{
        title
      }}</span>
      <input
        :type="type"
    ...
    <div class="relative w-full max-w-[106px] sm:max-w-[159px]">
      ...
      >
        <img
          :src="getImageSrc(exchangeSelected.img)"
          alt=""
...
export default defineComponent({
  ...
  props: {
    ...
    exchanges: {
      type: Array as PropType<Exchange[]>,
      required: true
    },
    type: {
      type: String,
